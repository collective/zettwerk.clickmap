...
class ClickmapTool(UniqueObject, SimpleItem): 
    ...
    def getControlPanel(self):
        """ some html to control the output of the image. """
        ...
        returner.append(u'<div id="clickmap_output_controller_dragger" style="font-weight: bold; float: right; width: 20px; height: 20px; background-color: orange; cursor: move; text-align: center;"> + </div>')
